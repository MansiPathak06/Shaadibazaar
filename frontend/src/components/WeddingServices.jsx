...
const WeddingServices = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      linear: 'from-rose-600 to-pink-600'
    },
    {
      id: 'furniture',
    ...
    <div className="min-h-screen bg-linear-to-br from-rose-50 via-white to-pink-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto text-center mb-12 animate-fade-in">
        <div className="inline-block mb-4">
          <span className="bg-linear-to-r from-rose-500 to-pink-600 text-white px-5 py-2 rounded-full text-base font-bold shadow-lg">
            ShaadiBazaar Services
          </span>
        </div>
        <h1 className="text-3xl md:text-4xl font-serif font-bold mb-4 bg-linear-to-r from-rose-600 via-pink-600 to-rose-500 bg-clip-text text-transparent">
                ...
                <div className="p-2 bg-white">
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <div className={`p-3 bg-linear-to-br ${service.linear} rounded-lg transform transition-transform duration-300 group-hover:scale-110`}>
                  ...
                  <button className={`flex items-center gap-1.5 px-4 py-1.5 bg-linear-to-r ${service.linear} text-white rounded-full font-semibold text-md hover:shadow-lg transform transition-all duration-300 hover:scale-105`}>
                    Explore
