...
export default function ModernWeddingGate() {
  ...
  // Double Door Card Component with proper animation and redirect
  const DoubleDoorCard = ({ item, index, type }) => {
    ...
    // THIS IS THE FIX - useEffect to handle animation when isOpen changes
    useEffect(() => {
      if (isOpen) {
        ...
        // Set redirect timeout after animation completes (800ms) + 3 seconds wait
    ...
    }, [isOpen, item.href, router]);

    // Handle door click - just sets the card to open state
    const handleDoorClick = () => {
      if (!isOpen) {
        setOpenCardIndex(cardId);
      }
    };
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <div
              className={`w-full h-full bg-gradient-to-br ${item.gradient} rounded-l-3xl shadow-2xl border-4 border-r-2 border-white/20 relative overflow-hidden`}
              style={{
          ...
          >
            <div
              className={`w-full h-full bg-gradient-to-bl ${item.gradient} rounded-r-3xl shadow-2xl border-4 border-l-2 border-white/20 relative overflow-hidden`}
              style={{
                backfaceVisibility: "hidden",
              }}
            >
          ...
          >
            <div
              className={`w-full h-full bg-gradient-to-br ${item.gradient} rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 flex flex-col items-center justify-center relative overflow-hidden`}
            >
              ...
              <div className="relative z-10 mb-3 sm:mb-4 md:mb-6">
                <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-28 md:h-28 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm animate-pulse">
                  <IconComponent
              ...
              <div className="relative z-10 flex flex-col items-center gap-3">
                <div className="text-white/90 text-sm sm:text-base font-medium flex items-center gap-2">
                  <span className="animate-pulse">Redirecting in 3 seconds</span>
                  <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 animate-bounce" />
                </div>
  ...
  if (!isMounted) {
    return (
      <div className="relative w-full h-screen bg-gradient-to-br from-slate-950 via-rose-950 to-slate-900" />
    );
  }
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-rose-950 to-slate-900">
      ...
      <div className="absolute top-4 sm:top-6 md:top-10 left-0 right-0 z-50 text-center px-2 sm:px-4 pointer-events-none">
        <div className="inline-flex items-center gap-1 sm:gap-2 px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 bg-gradient-to-r from-rose-500/20 via-pink-500/20 to-purple-500/20 backdrop-blur-md border border-rose-400/30 rounded-full shadow-lg animate-glow">
      ...
      >
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-rose-900/95 via-pink-900/95 to-rose-950/95 backdrop-blur-md border-r-2 border-rose-400/30 flex flex-col items-center justify-center px-3 sm:px-6 md:px-12">
            <div className="absolute inset-0 pointer-events-none">
              <DiamondPattern />
            </div>
            <div className="absolute inset-y-0 right-0 w-1 bg-gradient-to-b from-transparent via-rose-300 to-transparent animate-pulse-slow pointer-events-none"></div>

            <div className="absolute top-1/2 right-2 sm:right-4 md:right-8 transform -translate-y-1/2 w-4 sm:w-5 md:w-8 h-12 sm:h-16 md:h-28 bg-gradient-to-b from-rose-300 via-pink-400 to-rose-500 rounded-full border-2 border-rose-400/50 shadow-[0_0_20px_rgba(251,113,133,0.6)] animate-glow-pulse pointer-events-none">
            ...
            <div className="relative z-10 text-center space-y-2 sm:space-y-4 md:space-y-6 pointer-events-none">
              <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-rose-400 to-pink-600 rounded-full shadow-2xl mb-2 sm:mb-4 animate-pulse">
      ...
      >
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-bl from-violet-900/95 via-purple-900/95 to-rose-950/95 backdrop-blur-md border-l-2 border-purple-400/30 flex flex-col items-center justify-center px-3 sm:px-6 md:px-12">
            <div className="absolute inset-0 pointer-events-none">
              <DiamondPattern />
            </div>
            <div className="absolute inset-y-0 left-0 w-1 bg-gradient-to-b from-transparent via-purple-300 to-transparent animate-pulse-slow pointer-events-none"></div>

            <div className="absolute top-1/2 left-2 sm:left-4 md:left-8 transform -translate-y-1/2 w-4 sm:w-5 md:w-8 h-12 sm:h-16 md:h-28 bg-gradient-to-b from-purple-300 via-fuchsia-400 to-purple-500 rounded-full border-2 border-purple-400/50 shadow-[0_0_20px_rgba(192,132,252,0.6)] animate-glow-pulse pointer-events-none">
            ...
            <div className="relative z-10 text-center space-y-2 sm:space-y-4 md:space-y-6 pointer-events-none">
              <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-violet-400 to-purple-600 rounded-full shadow-2xl mb-2 sm:mb-4 animate-pulse">
      ...
      {gatesOpen && selectedGate === "products" && (
        <div className="absolute inset-0 z-30 bg-gradient-to-br from-rose-500/10 via-pink-500/10 to-purple-500/10 backdrop-blur-md overflow-y-auto scrollbar-thin scrollbar-thumb-rose-500/50 scrollbar-track-transparent">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 md:py-28">
            <div className="text-center mb-12 animate-slide-down">
              <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-rose-400 to-pink-600 rounded-full shadow-2xl mb-4">
              ...
              <div className="h-1 w-24 mx-auto bg-gradient-to-r from-rose-400 via-pink-500 to-purple-500 rounded-full shadow-lg mb-4"></div>
              <p className="text-rose-200/90 text-base sm:text-lg drop-shadow-md max-w-2xl mx-auto">
                Click on any card to view and automatically navigate after 3 seconds.
              </p>
            </div>
      ...
      {gatesOpen && selectedGate === "services" && (
        <div className="absolute inset-0 z-30 bg-gradient-to-br from-violet-500/10 via-purple-500/10 to-rose-500/10 backdrop-blur-md overflow-y-auto scrollbar-thin scrollbar-thumb-purple-500/50 scrollbar-track-transparent">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 md:py-28">
            <div className="text-center mb-12 animate-slide-down">
              <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-violet-400 to-purple-600 rounded-full shadow-2xl mb-4">
                <Sparkles className="w-8 h-8 sm:w-10 sm:h-10 text-white animate-pulse" />
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 drop-shadow-2xl">
                Our Services
              </h2>
              <div className="h-1 w-24 mx-auto bg-gradient-to-r from-violet-400 via-purple-500 to-fuchsia-500 rounded-full shadow-lg mb-4"></div>
