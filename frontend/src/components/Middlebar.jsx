...
const categories = [
    // Outfits
    {
        ...
        redirect_link: "/bride/hindu/makeup-hair"
    ...
    },
    {
        ...
        redirect_link: "/bride/all-services?category=muslim-bridal-services&subCategory=arabic-henna"
    },
    {
    ...
    },
    {
        ...
        redirect_link: "/bride/all-services?category=hindu-bridal-services&subCategory=bridal-hairstyle"
    },
    {
        name: "Choreography",
        image: "https://i.pinimg.com/1200x/34/9d/d7/349dd7c786ff8f0907d386c316554a75.jpg",
        color: "from-indigo-500 to-purple-400",
        redirect_link: "/wedding-vendors/choreographer"
    },
    {
        name: "Car Decoration",
        image: "https://i.pinimg.com/736x/78/28/f6/7828f6cef847422176c8c67166d57e0e.jpg",
        color: "from-sky-500 to-blue-400",
        redirect_link: "/groom/all-services?category=muslim-groom-services&subCategory=car-decoration"
    },
    {
        name: "Dhol Team",
        image: "https://i.pinimg.com/736x/98/5e/4f/985e4fd0de24a9ab950f96124ebde892.jpg",
        color: "from-fuchsia-500 to-pink-400",
        redirect_link: "/wedding-vendors/dhol"
    },
    {
...
const MiddleBar = () => {
    ...
    return (
        <section className="relative w-full py-16 bg-linear-to-r from-slate-50 via-white to-slate-50 overflow-hidden">
            <div
                ref={sliderRef}
                    ...
                    >
                        <div className="flex flex-col items-center gap-1 p-5 transition-all duration-300 hover:scale-110 cursor-pointer min-w-[180px]">
                            ...
                            <div className="relative">
                                {category.badge && (
                                    <span className="absolute -top-2 -right-2 z-10 px-3 py-1 text-[10px] font-bold text-white bg-linear-to-r from-red-500 to-orange-500 rounded-full animate-pulse shadow-lg">
                                        {category.badge}
                                    </span>
                                )}

                                {/* Circular border with linear */}
                                <div className={`relative w-35 h-35 rounded-full bg-linear-to-br ${category.color} p-1 shadow-lg group-hover:shadow-2xl transition-all duration-300 group-hover:scale-105`}>
                                    ...
                                    <div className="w-full h-full rounded-full bg-white p-1 overflow-hidden">
                                        <img
                                            ...
                                            onError={(e) => {
                                                // Fallback linear background if image fails to load
                                                e.target.style.display = 'none';
                                                e.target.parentElement.classList.add(`bg-linear-to-br`, ...category.color.split(' '));
                                            }}
                                        />
                                    </div>
                                </div>
                                ...
                                <div className={`absolute inset-0 w-28 h-28 rounded-full bg-linear-to-br ${category.color} opacity-0 group-hover:opacity-50 blur-xl transition-opacity duration-300 -z-10`} />
                            </div>

                            {/* Category name */}
                            <span className="text-sm font-semibold text-gray-700 text-center whitespace-nowrap group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300">
                                {category.name}
                            </span>
                        </div>
                    </div>
            ...
            {/* Fade edges */}
            <div className="pointer-events-none absolute inset-y-0 left-0 w-32 bg-linear-to-r from-slate-50 to-transparent" />
            <div className="pointer-events-none absolute inset-y-0 right-0 w-32 bg-linear-to-l from-slate-50 to-transparent" />
        </section>
    );
};
