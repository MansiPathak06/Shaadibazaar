  ...
  const navigationLinks = [
    ...
    },
    {
      ...
      pages: [
        ...
        { name: "Catering & Food Service Vendors", link: "/wedding-vendors/catering-and-food-service-vendors" },
        { name: "Transport & Logistics Vendors", link: "/wedding-vendors/transport-and-logistics-vendors" },
        { name: "Accommodation Vendors", link: "/wedding-vendors/accomodation-vendors" },
        {
          name: "Hospitality & Guest Management Vendors",
          link: "/wedding-vendors/hospitality-guest-management-vendors",
        },
        {
          name: "Event Setup  & Infrastructure Vendors",
          link: "/wedding-vendors/event-setup-and-infrastructure-vendors",
        },
        { name: "Photography & Media Vendors", link: "/wedding-vendors/photography-and-media-vendors" },
        { name: "Ceremony-Specific Vendors", link: "/wedding-vendors/ceremony-specific-vendors" },
        { name: "Shopping & Costume Vendors", link: "/wedding-vendors/shopping-and-costume-vendors" },
        { name: "Additional Support Services", link: "/wedding-vendors/additional-support-services" },
        { name: "Miscellaneous Vendors", link: "/wedding-vendors/miscellaneous-vendors" },
      ],
    },
    {
      ...
      categories: [
        {
          ...
          icon: Sparkles,
          pages: [
            { name: "Banquet Venues", link: "/venue-and-accommodation/wedding-venues/banquet-venues" },
            { name: "Outdoor Venues", link: "/venue-and-accommodation/wedding-venues/outdoor-venues" },
            { name: "Mixed Venues", link: "/venue-and-accommodation/wedding-venues/mixed-venues" },
            { name: "Destination Wedding Venues", link: "/venue-and-accommodation/wedding-venues/destination-wedding-venues" },
            { name: "Religious Venues", link: "/venue-and-accommodation/wedding-venues/religious-venues" },
            { name: "Cultural / Traditional Venues", link: "/venue-and-accommodation/wedding-venues/cultural-traditional-venues" },
            { name: " Modern & Unique Venues", link: "/venue-and-accommodation/wedding-venues/modern-and-unique-venues" },
          ],
        },
        {
          ...
          icon: Moon,
          pages: [
            { name: "Hotel Accommodation", link: "/venue-and-accommodation/accomodation-types/hotel-accomodation" },
            { name: "Guest Houses", link: "/venue-and-accommodation/accomodation-types/guest-houses" },
            { name: "Resort Accommodation", link: "/venue-and-accommodation/accomodation-types/resort-accomodation" },
            { name: "Homestays & Rentals", link: "/venue-and-accommodation/accomodation-types/homestays-and-rentals" },
            { name: "Wedding-Specific Accommodation", link: "/venue-and-accommodation/accomodation-types/wedding-specific"},
          ],
        },
        {
    ...
    },
    {
      ...
      pages: [
        ...
        },
        {
          ...
          link: "/wedding-planning-tools/logistics-and-vendor-management-tools",
        },
        {
