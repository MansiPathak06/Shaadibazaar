...
const EnhancedSidebar = ({ activeTab, setActiveTab, categoryOrder, groupedItems, sidebarItems }) => {
...
import { Search, TrendingUp, TrendingDown, Filter, Eye, MoreVertical, RefreshCw, Calendar } from 'lucide-react';
