  ...
  const showcases = [
    {
      ...
      linear: "from-violet-600 via-purple-600 to-indigo-600",
      products: [
        {
          name: "Sehra",
          badge: "Special offer",
        ...
        },
        {
          name: "Turban(Pagri)",
          badge: "Min. 40% Off",
          badgeColor: "bg-linear-to-r from-amber-500 to-orange-500",
          image: "https://i.pinimg.com/736x/f9/b9/e2/f9b9e2a9c881aa6db84dec21344a43ce.jpg"
        },
        {
          name: "Wedding Rings",
          badge: "Min. 50% Off",
          badgeColor: "bg-linear-to-r from-red-500 to-pink-500",
    ...
    },
    {
      ...
      linear: "from-orange-600 via-red-600 to-rose-600",
      products: [
        {
          name: "FarmHouses",
          badge: "Min. 50% Off",
          badgeColor: "bg-linear-to-r from-teal-600 to-cyan-600",
        ...
        },
        {
          name: "Hill Resorts",
          badge: "Min. 50% Off",
          badgeColor: "bg-linear-to-r from-sky-600 to-blue-600",
          image: "https://i.pinimg.com/736x/21/f8/3e/21f83e566ba0066ceefaa8403378c1c6.jpg"
        },
        {
          name: "Dining Hall",
          badge: "Min. 50% Off",
          badgeColor: "bg-linear-to-r from-amber-600 to-orange-600",
      ...
      products: [
        {
          name: "Pandit Ji",
          badge: "Up to 60% Off",
          badgeColor: "bg-linear-to-r from-indigo-600 to-purple-600",
          image: "https://i.pinimg.com/1200x/c2/0e/f4/c20ef488d21c47ff6ad07042b5aabae2.jpg"
        },
        {
          name: "Qazi for Nikah",
          badge: "Hot Deals",
          badgeColor: "bg-linear-to-r from-red-600 to-pink-600",
          image: "https://i.pinimg.com/736x/ac/de/a7/acdea7230a9b712c588d1f980159b1dc.jpg"
        },
        {
          name: "Granthi Ji",
          badge: "Min. 30% Off",
          badgeColor: "bg-linear-to-r from-violet-600 to-fuchsia-600",
      ...
      <div className="text-center pb-16 px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6">
          {showcases.map((showcase, index) => (
            ...
            >
              {/* Header with linear */}
              <div className={`relative bg-linear-to-r ${showcase.linear} p-5 overflow-hidden`}>
                  ...
                  {showcase.products.map((product, productIndex) => (
                    ...
                    >
                      <div className="relative overflow-hidden rounded-xl bg-gray-100 mb-3 shadow-md hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="absolute inset-0 bg-linear-to-t from-black/60 via-black/0 to-black/0 opacity-0 group-hover/item:opacity-100 transition-opacity duration-300" />
                        ...
                        {/* Shimmer effect */}
                        <div className="absolute inset-0 -translate-x-full group-hover/item:translate-x-full transition-transform duration-1000 bg-linear-to-r from-transparent via-white/30 to-transparent skew-x-12"></div>
                      </div>
                      
                      {/* Product Name */}
                      <h3 className="text-sm font-normal text-gray-800 group-hover/item:text-transparent group-hover/item:bg-linear-to-r group-hover/item:from-violet-600 group-hover/item:to-indigo-600 group-hover/item:bg-clip-text transition-all duration-300 line-clamp-2">
                        {product.name}
                      </h3>
                    </div>
                  ))}
              ...
              {/* Bottom shine effect */}
              <div className="h-1 bg-linear-to-r from-transparent via-white to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            </div>
          ))}
        </div>
      </div>
