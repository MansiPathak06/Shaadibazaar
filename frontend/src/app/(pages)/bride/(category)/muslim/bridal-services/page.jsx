...
const MuslimBridalServicesPage = () => {
  ...
  const heroSlides = [
    {
      title: "Muslim Bridal Makeup & Beauty",
      subtitle: "Elegant Services For Your Nikah Day",
      image:
        "https://i.pinimg.com/736x/5a/23/ca/5a23ca5b0bbc27ab70962c1d851136e1.jpg",
    },
    {
      title: "Complete Nikah Package",
      subtitle: "Everything You Need For A Blessed Wedding",
      image:
        "https://i.pinimg.com/1200x/6f/f7/cf/6ff7cf9f7d29e3acd8c19250f8e4ee54.jpg",
    },
    {
      title: "Expert Hijab Stylists & Artists",
          ...
          {heroSlides.map((_, index) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all ${
                currentSlide === index ? "bg-emerald-600 w-8" : "bg-white/60"
              }`}
            />
          ))}
        </div>
...
export default MuslimBridalServicesPage;