...
const RitualItemsPage = () => {
  ...
  const categories = [
    ...
    { name: 'Sindoor Box', items: 22, image: 'https://i.pinimg.com/736x/98/70/0e/98700e4c8ddf5c72c19a5b72f417fe37.jpg', slug: 'sindoor-box' },
    { name: 'Mangalsutra', items: 35, image: 'https://i.pinimg.com/1200x/32/d2/6e/32d26e87619efeda044db31d707f836c.jpg', slug: 'mangalsutra' },
    { name: 'Kanyadaan Items', items: 12, image: 'https://i.pinimg.com/1200x/21/4c/7e/214c7e21260f8a75daa98319d1947743.jpg', slug: 'kanyadaan-items' },
    { name: 'Coconut', items: 40, image: 'https://i.pinimg.com/736x/01/93/26/019326772e3e5fa777193372bbe84668.jpg', slug: 'coconut' },
    { name: 'Cloth for Muhurat', items: 14, image: 'https://i.pinimg.com/1200x/c0/9f/8a/c09f8ac9b1728005843312974ba71544.jpg', slug: 'cloth-for-muhurat' }
  ];

  const featuredProducts = [
    { name: 'Haldi Ubtan', discount: '30% OFF', image: 'https://i.pinimg.com/736x/eb/bc/f2/ebbcf2e5d4622e8c295b8c4dfa725af3.jpg', slug: 'haldi-ubtan' },
    { name: 'Sacred Pooja Thali', discount: '25% OFF', image: 'https://i.pinimg.com/736x/ce/14/4b/ce144beeaf0a7d667f415df49b7de1af.jpg', slug: 'pooja-thali' },
    { name: 'Traditional Kalire', discount: '35% OFF', image: 'https://i.pinimg.com/1200x/97/7e/cc/977ecc7e6a1823d9025bfeefc2b8e8ff.jpg', slug: 'kalire' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        {/* Featured Products Section - Now Clickable */}
