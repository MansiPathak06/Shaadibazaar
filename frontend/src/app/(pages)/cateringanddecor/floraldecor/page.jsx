...
import { Heart, Sparkles, Camera, Phone, Mail, MapPin, Menu, X, ChefHat, Crown, Gem, Users, Calendar, Award, CheckCircle, Star, Utensils, FlowerIcon as Flower, Clock, Send, ArrowRight } from 'lucide-react';
    ...
    <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-light text-gray-800 mb-4">
            {title.split(' ').map((word, index) => {
                ...
                return isLastWord ? (
                    <span key={index} className="font-semibold text-rose-500">{word}</span>
                ) : (
...
export default function FloralDecorWebsite() {
    ...
    const galleryItems = [
        // Stage Floral Décor
        {
            ...
            image: 'https://i.pinimg.com/736x/d0/09/80/d00980758dae79cdad708a073454a2bd.jpg',
            size: 'large'
        },
        {
            id: 2,
        ...
        },
        {
            ...
            image: 'https://i.pinimg.com/736x/3d/dc/cd/3ddccdc7e4b2466912b2e2a4b5623dd9.jpg',
            size: 'medium'
        },
        ...
        // Banquet Floral Décor
        {
            ...
            image: 'https://i.pinimg.com/736x/ae/91/8d/ae918d723bcc84209d38b97d0a368819.jpg',
            size: 'large'
        },
        {
            id: 5,
            ...
            image: 'https://i.pinimg.com/736x/c7/51/8a/c7518a8fa4a37cd7825195d490f13f6a.jpg',
            size: 'medium'
        },
        {
            id: 6,
            ...
            image: 'https://i.pinimg.com/736x/82/59/d7/8259d79bb4096775500c0b41b5facb4a.jpg',
            size: 'small'
        },
        ...
        // Mandap Floral Décor
        {
            ...
            image: 'https://i.pinimg.com/1200x/f9/c5/c2/f9c5c2a56103cd0e1d61931b07b6b84a.jpg',
            size: 'wide'
        },
        {
            id: 8,
            ...
            image: 'https://i.pinimg.com/736x/d0/95/17/d0951711f28bd3e8e38a0bd842b241a7.jpg',
            size: 'medium'
        },
        {
            id: 9,
            ...
            image: 'https://i.pinimg.com/736x/f1/4a/dc/f14adcbd0e27f151fe2706f2f7412dff.jpg',
            size: 'medium'
        },
        ...
        // Custom Furniture
        {
            ...
            image: 'https://i.pinimg.com/1200x/22/30/f0/2230f05b81ccf258c1776d7ff7f3887c.jpg',
            size: 'large'
        },
        {
            id: 11,
            ...
            image: 'https://i.pinimg.com/1200x/b7/9e/1d/b79e1d33c4fcaf633a1ca372ba3b0c69.jpg',
            size: 'medium'
        },
        ...
        // Welcome Décor
        {
            ...
            image: 'https://i.pinimg.com/736x/e5/f7/d4/e5f7d4b15cb30c097951b3bfff66f017.jpg',
            size: 'wide'
        },
        {
            id: 13,
            ...
            image: 'https://i.pinimg.com/1200x/46/be/90/46be904629f12c5496a9d2f88eab1bd5.jpg',
            size: 'medium'
        },
        ...
        // Extra Floral Décor
        {
            ...
            image: 'https://i.pinimg.com/736x/da/82/b4/da82b4a41c2a053684c7ba283a1bb555.jpg',
            size: 'tall'
        },
        {
            id: 15,
            ...
            image: 'https://i.pinimg.com/736x/ca/7c/0b/ca7c0b2a2188b26165c04c21798ae53d.jpg',
            size: 'square'
        }
    ];
    ...
    return (
        <div className="bg-gradient-to-br from-rose-50 to-pink-50">
            ...
            {/* Hero Section */}
            <section id="home" className="relative flex items-end min-h-screen overflow-hidden">
                ...
                <div className="relative z-10 w-full pb-12 md:pb-16 lg:pb-20">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-light text-white mb-6 leading-tight">
                            ...
                            <span className="font-serif italic text-rose-300">Tells a Story</span>
                        </h1>
                        ...
                        <p className="text-rose-300 font-light text-lg mb-8">
                            Each petal placed with purpose, every arrangement crafted with love.
                        </p>
                ...
                <div className="absolute top-1/2 left-12 opacity-25 animate-pulse z-10" style={{ animationDelay: '1s' }}>
                    <div className="w-2 h-2 bg-amber-300 rounded-full"></div>
                </div>
                <div className="absolute bottom-1/3 right-1/4 opacity-20 animate-pulse z-10" style={{ animationDelay: '2s' }}>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="relative group">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 text-white">
                                <h3 className="text-2xl font-semibold mb-2">Grand Welcome Arch</h3>
                                <p className="text-white/90">Majestic floral gateway that welcomes guests</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            <div>
                                <h3 className="text-3xl font-light text-gray-800 mb-4">
                                    First Moments, <span className="font-semibold text-rose-500">Lasting Memories</span>
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Your guests' journey begins at the entrance. Our welcome decorations create anticipation and excitement, setting the perfect mood for the celebration ahead.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div className="flex items-start gap-4 p-4 bg-rose-50 rounded-lg">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-gray-800 mb-1">Entrance Pathways</h4>
                                        <p className="text-gray-600 text-sm">Petal-strewn walkways lined with elegant arrangements guide guests to your celebration.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4 p-4 bg-rose-50 rounded-lg">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-gray-800 mb-1">Welcome Signage</h4>
                                        <p className="text-gray-600 text-sm">Personalized floral frames and elegant signage that welcome guests by name.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4 p-4 bg-rose-50 rounded-lg">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-gray-800 mb-1">Greeting Areas</h4>
                                        <p className="text-gray-600 text-sm">Designated spaces with floral arrangements for receiving and greeting guests.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        {galleryCategories.map((category) => (
                            <button
                                ...
                                className={`px-6 py-3 rounded-full text-sm font-medium transition-all ${selectedCategory === category.id
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-[200px]">
                        {filteredItems.map((item, index) => (
                            <div
                                key={item.id}
                                className={`group relative overflow-hidden rounded-2xl hover:shadow-2xl transition-all duration-500 ${getGridClasses(item.size)}`}
                            >
                                <img
                                    src={item.image}
                                    alt={item.title}
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg group hover:shadow-xl transition-shadow">
                            ...
                            <div className="p-6">
                                <h3 className="text-lg font-semibold text-gray-800 mb-2">Spring Collection</h3>
                                <p className="text-gray-600 text-sm">Tulips, daffodils, cherry blossoms</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg group hover:shadow-xl transition-shadow">
                            ...
                            <div className="p-6">
                                <h3 className="text-lg font-semibold text-gray-800 mb-2">Summer Blooms</h3>
                                <p className="text-gray-600 text-sm">Sunflowers, dahlias, marigolds</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg group hover:shadow-xl transition-shadow">
                            ...
                            <div className="p-6">
                                <h3 className="text-lg font-semibold text-gray-800 mb-2">Autumn Harvest</h3>
                                <p className="text-gray-600 text-sm">Chrysanthemums, asters, roses</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg group hover:shadow-xl transition-shadow">
                            ...
                            <div className="p-6">
                                <h3 className="text-lg font-semibold text-gray-800 mb-2">Winter Elegance</h3>
                                <p className="text-gray-600 text-sm">Poinsettias, amaryllis, evergreens</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="group">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div className="absolute bottom-6 left-6 right-6 text-white">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <h3 className="text-xl font-semibold mb-1">Classic White Roses</h3>
                                                <p className="text-white/90 text-sm">Timeless elegance</p>
                                            </div>
                            ...
                            <div className="text-center">
                                <h3 className="text-lg font-semibold text-gray-800 mb-2">Traditional Beauty</h3>
                                <p className="text-gray-600 text-sm">Pure white roses with baby's breath and satin ribbons</p>
                            </div>
                        </div>
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden rounded-2xl mb-6">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div className="absolute bottom-6 left-6 right-6 text-white">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <h3 className="text-xl font-semibold mb-1">Garden Mix</h3>
                                                <p className="text-white/90 text-sm">Colorful variety</p>
                                            </div>
                            ...
                            <div className="text-center">
                                <h3 className="text-lg font-semibold text-gray-800 mb-2">Wildflower Romance</h3>
                                <p className="text-gray-600 text-sm">Mixed seasonal blooms with natural greenery</p>
                            </div>
                        </div>
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden rounded-2xl mb-6">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div className="absolute bottom-6 left-6 right-6 text-white">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <h3 className="text-xl font-semibold mb-1">Exotic Orchids</h3>
                                                <p className="text-white/90 text-sm">Modern sophistication</p>
                                            </div>
                            ...
                            <div className="text-center">
                                <h3 className="text-lg font-semibold text-gray-800 mb-2">Tropical Elegance</h3>
                                <p className="text-gray-600 text-sm">Premium orchids with minimalist styling</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div className="text-center">
                            ...
                            <h4 className="font-semibold text-gray-800 mb-1">Cascade Style</h4>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="relative group">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 text-white">
                                <h3 className="text-2xl font-semibold mb-2">Royal Stage Backdrop</h3>
                                <p className="text-white/90">Majestic floral arrangements with royal elegance</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div className="bg-white rounded-xl p-6 shadow-lg">
                                ...
                                <h3 className="text-xl font-semibold text-gray-800 mb-3">Flower Walls & Backdrops</h3>
                                <p className="text-gray-600 text-sm">Stunning vertical gardens and floral walls that create the perfect backdrop for your special moments.</p>
                            </div>

                            <div className="bg-white rounded-xl p-6 shadow-lg">
                                <Sparkles className="w-8 h-8 text-rose-500 mb-4" />
                                <h3 className="text-xl font-semibold text-gray-800 mb-3">Hanging Installations</h3>
                                <p className="text-gray-600 text-sm">Ethereal suspended arrangements and chandeliers that add drama and elegance to your stage.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
                            ...
                            <div className="p-6">
                                ...
                                <h3 className="text-xl font-semibold text-gray-800 mb-2">Bridal Throne Sets</h3>
                                <p className="text-gray-600 text-sm">Ornate seating arrangements fit for royalty, adorned with fresh flowers and luxury fabrics.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
                            ...
                            <div className="p-6">
                                ...
                                <h3 className="text-xl font-semibold text-gray-800 mb-2">Elegant Lounge Sets</h3>
                                <p className="text-gray-600 text-sm">Comfortable and stylish seating areas perfect for guests to relax and enjoy the celebration.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
                            ...
                            <div className="p-6">
                                ...
                                <h3 className="text-xl font-semibold text-gray-800 mb-2">Floral Chair Covers</h3>
                                <p className="text-gray-600 text-sm">Transform ordinary chairs with elegant covers, floral accents, and coordinated color schemes.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow group">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mb-3">Flower Tunnels</h3>
                            <p className="text-gray-600 text-sm">Enchanting pathways lined with blooms that create magical walkways for the couple and guests.</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow group">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mb-3">Hanging Chandeliers</h3>
                            <p className="text-gray-600 text-sm">Suspended floral masterpieces that add vertical drama and elegance to your venue spaces.</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow group">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mb-3">Photo Zones</h3>
                            <p className="text-gray-600 text-sm">Instagram-worthy floral backdrops designed specifically for capturing beautiful memories.</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow group">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mb-3">Ceiling Drapes</h3>
                            <p className="text-gray-600 text-sm">Ethereal overhead arrangements with flowing fabrics and cascading flowers for dramatic effect.</p>
                        </div>
                    </div>
                </div>
            </section>
