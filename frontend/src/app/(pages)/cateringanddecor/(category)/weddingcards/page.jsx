...
export default function WeddingCardsPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-rose-50/20 to-purple-50/10">
      ...
      <section className="relative h-[70vh] md:h-[80vh] overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-br from-rose-500/40 via-pink-500/30 to-purple-500/40"></div>
          ...
          <div className="max-w-5xl">
            ...
            <div className="relative">
              ...
              <div className="relative p-12 md:p-16">
                <h1 className="text-6xl md:text-8xl font-medium bg-linear-to-r from-white via-rose-50 to-white bg-clip-text text-transparent mb-6 drop-shadow-2xl leading-tight">
                Crafting <span className='bg-clip-text text-transparent bg-linear-to-r from-rose-500 to-pink-500'>Your</span> Perfect  <span className='bg-clip-text text-transparent bg-linear-to-r from-rose-500 to-pink-500'>Wedding Invitations</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-5 justify-center">
                  <a href="/cateringanddecor/all-services?category=weddingcards">
                    <button className="group relative bg-white/90 backdrop-blur-sm text-rose-500 px-10 py-5 md:px-40 rounded-2xl font-normal cursor-pointer text-lg hover:bg-white transition-all shadow-2xl overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-linear-to-r from-rose-400/0 via-rose-400/10 to-rose-400/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
                    </button>
                  </a>
                </div>
              </div>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
            <path d="M0 120L60 110C120 100 240 80 360 70C480 60 600 60 720 65C840 70 960 80 1080 85C1200 90 1320 90 1380 90L1440 90V120H1380C1320 120 1200 120 1080 120C960 120 840 120 720 120C600 120 480 120 360 120C240 120 120 120 60 120H0Z" fill="url(#wave-linear)" />
            <defs>
              <linearlinear id="wave-linear" x1="0" y1="0" x2="0" y2="1">
      ...
      <section className="lg:pt-28 px-4 max-w-7xl mx-auto">
        <div className="text-center md:mb-20 mb-16">
          <h2 className="text-4xl md:text-6xl mb-3 font-light text-neutral-800 tracking-tight uppercase">
            <span className='bg-clip-text text-transparent bg-linear-to-r from-rose-500 to-pink-500'>Welcome</span> to Shaddi <span className="bg-clip-text text-transparent bg-linear-to-r from-rose-500 to-pink-500">Bazaar</span> <br /> Wedding <span className='bg-clip-text text-transparent bg-linear-to-r from-rose-500 to-pink-500'>Cards</span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {[
            { value: '5000+', label: 'Designs', linear: 'from-rose-500 to-pink-500' },
            { value: '10000+', label: 'Happy Couples', linear: 'from-pink-500 to-purple-500' },
            { value: '100%', label: 'Customizable', linear: 'from-purple-500 to-rose-500' },
            { value: '24/7', label: 'Support', linear: 'from-rose-500 to-orange-500' },
          ].map((stat, index) => (
            <div key={index} className="group relative">
              <div
                className={`absolute inset-0 bg-linear-to-br ${stat.linear} opacity-10 rounded-3xl blur-xl group-hover:opacity-20 transition-opacity`}
              ></div>
              <div className="relative text-center p-8 bg-white/60 backdrop-blur-lg rounded-3xl border border-white/40 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
                <div className={`text-5xl font-medium bg-linear-to-r ${stat.linear} bg-clip-text text-transparent mb-3`}>
                  {stat.value}
                </div>
      ...
      <section className="px-4 py-24 relative overflow-hidden">
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl mb-3 font-light text-neutral-800 tracking-tight uppercase">
              Explore Our <span className="bg-linear-to-r from-rose-500 to-pink-500 text-transparent bg-clip-text">Collections</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {cardCategories.map((category) => (
              <div key={category.id} className="group relative ">
                <div className="absolute inset-0 bg-linear-to-br from-rose-400/30 to-purple-400/30 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {category.features.map((feature, idx) => (
                        <span
                          key={idx}
                          className="bg-linear-to-r from-rose-100 to-pink-100 text-rose-600 text-sm px-3 py-1.5 rounded-full border border-rose-200/50 whitespace-nowrap font-medium"
                        >
                          {feature}
                        </span>
                      ))}
                    ...
                    <a href="/cateringanddecor/all-services?category=weddingcards">
                      <button className="w-full relative bg-linear-to-r from-rose-500 to-pink-500 text-white py-3.5 rounded-2xl font-normal hover:shadow-lg transition-all overflow-hidden group/btn cursor-pointer">
                        <span className="relative z-10">Explore Designs</span>
                        <div className="absolute inset-0 bg-linear-to-r from-pink-500 to-purple-500 opacity-0 group-hover/btn:opacity-100 transition-opacity"></div>
                      </button>
                    </a>
                  </div>
                </div>
      ...
      <section className="py-14 px-4 relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-b from-rose-50/50 via-purple-50/30 to-rose-50/50"></div>

        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl mb-3 font-light text-neutral-800 tracking-tight uppercase">
              Our Featured <span className="bg-clip-text text-transparent bg-linear-to-r from-rose-500 to-pink-500">Designs</span>
            </h2>
              ...
              <button
                ...
                className={`relative px-8 py-4 rounded-2xl font-normal cursor-pointer transition-all overflow-hidden ${
                  selectedCategory === filter.id
                    ? 'bg-linear-to-r from-rose-500 to-pink-500 text-white shadow-xl scale-105'
              ...
              .map((item) => (
                <div key={item.id} className="group relative">
                  ...
                  <div className="relative rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border-4 border-white">
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-t from-gray-900/90 via-gray-900/50 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500">
                      <div className="absolute bottom-0 left-0 right-0 p-8 text-white transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                        ...
                        <a href="/cateringanddecor/all-services?category=weddingcards">
                          <button className="relative bg-white text-rose-500 px-8 py-3 rounded-2xl font-normal hover:bg-rose-50 transition-all shadow-xl overflow-hidden group/btn cursor-pointer">
                            ...
                            <div className="absolute inset-0 bg-linear-to-r from-rose-100 to-pink-100 opacity-0 group-hover/btn:opacity-100 transition-opacity"></div>
                          </button>
                        </a>
                      </div>
                    </div>
      ...
      <section className="px-4 py-24 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl mb-3 font-light text-neutral-800 tracking-tight uppercase">
              How It <span className='bg-clip-text text-transparent bg-linear-to-r from-rose-500 to-pink-500'>Works</span>
            </h2>
          ...
          <div className="space-y-8">
            {[
              { step: '01', title: 'Choose Your Design', desc: 'Browse our collection or request a custom design', linear: 'from-rose-500 to-pink-500' },
              { step: '02', title: 'Customize Details', desc: 'Add your wedding information, colors, and personal touches', linear: 'from-pink-500 to-purple-500' },
              { step: '03', title: 'Approve Sample', desc: 'Review and approve your digital or physical sample', linear: 'from-purple-500 to-rose-500' },
              { step: '04', title: 'Print & Deliver', desc: 'We print and deliver your cards to your doorstep', linear: 'from-rose-500 to-orange-500' }
            ].map((item, index) => (
              <div key={index} className="group flex items-center gap-8">
                {/* Number Circle */}
                <div className="relative shrink-0">
                  <div className={`absolute inset-0 bg-linear-to-br ${item.linear} opacity-30 rounded-full blur-xl group-hover:opacity-50 transition-all`}></div>
                  <div className={`relative w-24 h-24 bg-linear-to-br ${item.linear} text-white rounded-full flex items-center justify-center text-3xl font-bold group-hover:scale-110 transition-all shadow-xl`}>
                    {item.step}
                  </div>
                </div>
                ...
                <div className="flex-1 relative">
                  <div className={`absolute inset-0 bg-linear-to-r ${item.linear} opacity-10 rounded-3xl blur-lg group-hover:opacity-20 transition-all`}></div>
                  <div className="relative bg-white/80 backdrop-blur-sm p-8 rounded-3xl border border-gray-100 shadow-lg group-hover:shadow-xl transition-all">
                    <h3 className={`text-2xl font-medium bg-linear-to-r ${item.linear} bg-clip-text text-transparent mb-3`}>{item.title}</h3>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-br from-rose-50 via-purple-50/50 to-pink-50"></div>
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl mb-3 font-light text-neutral-800 tracking-tight uppercase">
              What Our <span className='bg-clip-text text-transparent bg-linear-to-r from-rose-500 to-pink-500'>Couples Say</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              { name: 'Priya & Rahul', review: 'The laser-cut designs were absolutely stunning! Our guests loved the intricate details.', image: 'https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=200&h=200&fit=crop', linear: 'from-rose-500 to-pink-500' },
              { name: 'Anjali & Vikram', review: 'ShaadiBAzaar made our dream cards a reality. The customization options were endless!', image: 'https://images.unsplash.com/photo-1522673607200-164d1b6ce486?w=200&h=200&fit=crop', linear: 'from-pink-500 to-purple-500' },
              { name: 'Neha & Arjun', review: 'From consultation to delivery, the service was impeccable. Highly recommended!', image: 'https://images.unsplash.com/photo-1519741497674-611481863552?w=200&h=200&fit=crop', linear: 'from-purple-500 to-rose-500' }
            ].map((testimonial, index) => (
              <div key={index} className="group relative">
                <div className={`absolute inset-0 bg-linear-to-br ${testimonial.linear} opacity-20 rounded-3xl blur-xl group-hover:opacity-30 transition-all`}></div>
                ...
                <div className="relative bg-white/70 backdrop-blur-lg p-10 rounded-3xl border border-white/50 shadow-xl hover:shadow-2xl transition-all group-hover:scale-105">
                  <div className="flex justify-center mb-6">
                    <div className="relative">
                      <div className={`absolute inset-0 bg-linear-to-br ${testimonial.linear} rounded-full blur-md`}></div>
                      <img
                        ...
                        style={{ borderImage: `linear-linear(to right, var(--tw-linear-stops)) 1` }}
                      />
                    </div>
                  </div>
                  <div className={`text-6xl mb-6 text-center bg-linear-to-r ${testimonial.linear} bg-clip-text text-transparent`}>"</div>
                  <p className="text-gray-700 mb-8 italic text-center leading-relaxed text-lg">{testimonial.review}</p>
                  <p className={`font-medium text-center text-xl bg-linear-to-r ${testimonial.linear} bg-clip-text text-transparent`}>- {testimonial.name}</p>
                </div>
              </div>
            ))}
          </div>
