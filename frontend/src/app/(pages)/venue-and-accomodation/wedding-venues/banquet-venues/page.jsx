    ...
    <div className="min-h-screen bg-linear-to-b from-purple-50 to-pink-50">
      ...
      <div className="relative h-[70vh] md:h-[77vh] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-4 py-6">
          ...
          {/* Main Heading */}
          <h1 className="text-3xl md:text-6xl uppercase mt-5 font-medium text-white mb-3 text-center leading-tight max-w-3xl">
            Exploring venues and <br />
            conquering memories
          </h1>
          {/* Description */}
      ...
      <div className="container mx-auto px-40 py-16">
        <h2 className="text-3xl font-medium text-purple-900 mb-8 uppercase tracking-wide">
            ...
            >
              <div className="bg-white rounded-lg shadow-md overflow-hidden transform group-hover:scale-105 transition-all duration-300 group-hover:shadow-lg">
                ...
                <div className="p-3 text-center">
                  <h3 className="text-sm md:text-lg font-medium text-gray-800 mb-1 capitalize">
                    {category.title}
                  </h3>
                  <span
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <div>
              <h2 className="text-4xl md:text-5xl font-medium text-purple-900 mb-6 uppercase tracking-wide ">
                About Our Venues
              </h2>
              ...
              <div className="grid grid-cols-3 gap-6 text-center">
                ...
                <div>
                  ...
                  <h4 className="font-medium text-purple-900">BEST VALUE</h4>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="bg-linear-to-r from-purple-50 to-pink-50 rounded-2xl p-12 shadow-xl">
          <h2 className="text-4xl md:text-5xl font-medium text-purple-900 mb-8 text-center uppercase tracking-wide">
