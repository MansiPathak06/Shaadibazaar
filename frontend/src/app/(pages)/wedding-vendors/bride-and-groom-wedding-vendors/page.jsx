...
import { Home, ChevronRight as BreadcrumbArrow, ChevronRight  } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[50vh] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white px-4 z-10">
          <h1 className="text-4xl md:text-6xl uppercase font-medium mb-2 text-center drop-shadow-lg">
    ...
    <div className="bg-white border-b border-gray-200 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-rose-500 font-medium text-lg">Bride & Groom Beauty Vendors</span>
          </nav>
        </div>
      </div>
