  ...
  const vendors = [
    {
      ...
      name: "Wedding Planner",
      description:
        "Offers complete comprehensive solutions to provide the ultimate blissful wedding experience from the heart",
    ...
    },
    {
      ...
      name: "Event Manager",
      description:
        "Make families celebrate as we work on your full-service event coordination from start to finish",
    ...
    },
    {
      ...
      name: "Venue Manager",
      description:
        "Exquisite venues with world-class amenities and spectacular decor to create an unforgettable celebration",
    ...
    },
    {
      ...
      description:
        "Blissful transformation where creative visions meet and bring sophistication to your special ceremony",
    ...
    },
    {
      ...
      description:
        "Soul-tingling cuisine and delicious menu thought-out with authentic flavors to make this celebration special",
    ...
    },
    {
      ...
      name: "Photographer",
      description:
        "Capturing every precious moment and every emotion beautifully - turning your celebration into timeless memories",
    ...
    },
    {
      ...
      name: "Videographer",
      description:
        "Cinematic storytelling that brings your wedding day to life with artistic shots and emotional narratives",
    ...
    },
    {
      ...
      description:
        "Professional lighting and crystal-clear sound systems to set the perfect ambiance and energy",
    
      image:
        "https://i.pinimg.com/736x/b1/37/5f/b1375f788d1f8a3dbe8c6ce7290e3ef6.jpg",
    },
    {
      id: 9,
      category: "dj",
      ...
      description:
        "High-energy entertainment with premium sound and lighting to keep your guests dancing all night",
     
      image:
        "https://i.pinimg.com/1200x/eb/f9/cc/ebf9cc1182a0d47ecf849afa90d49c3f.jpg",
    },
    {
      id: 10,
      category: "band",
      ...
      description:
        "Traditional brass band performances adding grandeur and festive spirit to your wedding procession",
    ...
    },
    {
      ...
      description:
        "Beautifully decorated horses for the groom&apso;s baraat entry, creating a royal and memorable entrance",
     
      image:
        "https://i.pinimg.com/1200x/26/dd/f8/26ddf8a2720dbf0d2353ef7a18314f64.jpg",
    },
    {
      id: 12,
      category: "dhol",
      name: "Dhol Team",
      description:
        "Energetic dhol players who bring infectious enthusiasm and traditional beats to your celebration",
     
      image:
        "https://i.pinimg.com/736x/9a/e4/d2/9ae4d23861b72d5f987e4e810a0ff86f.jpg",
    },
    {
      id: 13,
      category: "fireworks",
      ...
      description:
        "Spectacular fireworks displays that light up the sky and add magic to your special moments",
     
      image:
        "https://i.pinimg.com/736x/f4/21/57/f42157ae6d72f09dee7b4bcb0321d2d6.jpg",
    },
    {
      id: 14,
      category: "tent",
      ...
      description:
        "Premium tenting solutions with elegant structures and comfortable seating arrangements",
 
      image:
        "https://i.pinimg.com/736x/65/bb/16/65bb161ae79618fe745be4be8d1213a1.jpg",
    },
  ];
