...
const GroomEssentialsPage = () => {
  ...
  const handleCategoryClick = (subCategory) => {
    router.push(`/groom/all-products?category=general-essentials&subCategory=${subCategory}`);
  };

  const handleAllProductsClick = () => {
    router.push("/groom/all-products?category=general-essentials");
  };
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="max-w-xl">
            ...
            <button 
              ...
              className="mt-6 bg-blue-600 text-white px-8 py-3 rounded-full hover:bg-blue-700 transition-colors shadow-lg cursor-pointer"
            >
              Shop Now
            </button>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex gap-6">
            <button 
              onClick={handleAllProductsClick}
              className="text-gray-800 font-semibold border-b-2 border-blue-600 pb-2 cursor-pointer"
            >
              All Items
            </button>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <button className="w-full mt-3 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-2">
