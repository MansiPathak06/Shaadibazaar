...
const ChristianGroomServicesPage = () => {
  ...
  // Groom services categories with subCategory mapping
  const categories = [
    {
      name: "Groom Styling",
    ...
    },
    {
      ...
      subCategory: "choir-band"
    },
  ];

  // Featured / trending style services with subCategory mapping
  ...
  const handleCategoryClick = (subCategory) => {
    router.push(`/groom/all-services?category=christian-groom-services&subCategory=${subCategory}`);
  };

  const handleAllServicesClick = () => {
    router.push("/groom/all-services?category=christian-groom-services");
  };
      ...
      <div className="max-w-7xl mx-auto px-8 py-16">
        <div className="grid md:grid-cols-2 gap-8">
          <div 
            ...
            onClick={() => handleCategoryClick("groom-styling")}
          >
            <img
          ...
          <div 
            className="relative overflow-hidden rounded-lg group cursor-pointer"
            onClick={() => handleCategoryClick("choir-band")}
          >
            <img
