...
const FunctionalSpacesPage = () => {
  ...
  const features = [
    { icon: Users, text: "Complete Facilities", color: "text-pink-300" },
    { icon: MapPin, text: "Strategic Layout", color: "text-purple-300" },
    { icon: Calendar, text: "Modern Amenities", color: "text-fuchsia-300" },
  ];
      ...
      <div className="relative h-[70vh] md:h-[77vh] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            ...
            alt="Functional Spaces Background"
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-4 py-6">
          ...
          <p className="text-sm md:text-base text-white/90 text-center max-w-xl mb-4 leading-relaxed">
            Discover comprehensive functional areas designed to make your event
            seamless and memorable. From catering facilities to entertainment zones.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 max-w-3xl w-full">
            {heroItems.map((item, index) => (
              <Link
                key={index}
                href={`/wedding-venues/all-venues?category=functional-spaces&subCategory=${item.slug}`}
        ...
        <div className="py-2">
          <div className="animate-marquee whitespace-nowrap inline-block">
            <span className="text-purple-100 text-sm md:text-base font-light tracking-widest mx-8">
              ✨ COMPLETE FUNCTIONAL SPACES FOR SEAMLESS EVENTS
            </span>
            <span className="text-purple-100 text-sm md:text-base font-light tracking-widest mx-8">
              🎊 MODERN FACILITIES & AMENITIES
            </span>
            <span className="text-purple-100 text-sm md:text-base font-light tracking-widest mx-8">
              🏛️ DESIGNED FOR EXCELLENCE
            </span>
            <span className="text-purple-100 text-sm md:text-base font-light tracking-widest mx-8">
              ✨ COMPLETE FUNCTIONAL SPACES FOR SEAMLESS EVENTS
            </span>
      ...
      <div className="container mx-auto px-40 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 mb-10">
          {categories.map((category, index) => (
            <Link
              key={index}
              href={`/wedding-venues/all-venues?category=functional-spaces&subCategory=${category.slug}`}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <div>
              <h2 className="text-3xl font-bold text-purple-900 mb-6 uppercase tracking-wide">
                About Our Functional Spaces
              </h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
                Every successful event requires well-planned functional spaces
                that work seamlessly behind the scenes. Our comprehensive range
                of functional areas ensures your event runs smoothly from start
                to finish.
              </p>
              <p className="text-gray-700 mb-6 leading-relaxed">
                From professional catering kitchens to elegant buffet sections,
                vibrant dance floors to essential storage areas, we provide all
                the functional spaces you need to create an unforgettable
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="bg-linear-to-r from-purple-50 to-pink-50 rounded-2xl p-12 shadow-xl">
          <h2 className="text-3xl font-bold text-purple-900 mb-8 text-center uppercase tracking-wide">
            Complete Functional Space Solutions
          </h2>
          <p className="text-center text-gray-700 max-w-3xl mx-auto mb-8 leading-relaxed">
            Explore our comprehensive collection of functional spaces designed
            to support every aspect of your event. From catering and dining
            areas to entertainment zones and essential facilities, we provide
            everything you need for a flawless celebration.
          </p>
          <div className="text-center">
            <Link
              href="/wedding-venues/all-venues?category=functional-spaces"
...
export default FunctionalSpacesPage;