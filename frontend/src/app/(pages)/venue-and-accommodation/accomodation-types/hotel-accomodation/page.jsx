...
import { Sparkles, MapPin, Users, Calendar, Star, Coffee, Wifi } from "lucide-react";
...
const HotelAccommodationPage = () => {
  ...
  const features = [
    { icon: Star, text: "Luxury Amenities", color: "text-pink-300" },
    { icon: MapPin, text: "Prime Locations", color: "text-purple-300" },
    { icon: Coffee, text: "24/7 Service", color: "text-fuchsia-300" },
  ];
      ...
      <div className="relative h-[70vh] md:h-[77vh] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-4 py-6">
          ...
          <p className="text-sm md:text-base text-white/90 text-center max-w-xl mb-4 leading-relaxed">
            Experience world-class hospitality with our curated selection of premium hotels and accommodations. From luxury suites to comfortable budget stays, find your perfect home away from home.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 max-w-3xl w-full">
            {heroItems.map((item, index) => (
              <Link
                key={index}
                href={`/venue-and-accommodation/all-venues?category=hotel-accommodation&subCategory=${item.slug}`}
        ...
        <div className="py-2">
          <div className="animate-marquee whitespace-nowrap inline-block">
            <span className="text-purple-100 text-sm md:text-base font-light tracking-widest mx-8">
              ✨ EXCEPTIONAL ACCOMMODATIONS FOR MEMORABLE STAYS
            </span>
            <span className="text-purple-100 text-sm md:text-base font-light tracking-widest mx-8">
      ...
      <div className="container mx-auto px-40 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 mb-10">
          {categories.map((category, index) => (
            <Link
              key={index}
              href={`/venue-and-accommodation/all-venues?category=hotel-accommodation&subCategory=${category.slug}`}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <div>
              <h2 className="text-3xl font-bold text-purple-900 mb-6 uppercase tracking-wide">
                About Our Hotel Collection
              </h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
                We believe that the right accommodation can transform your entire event experience. Our carefully curated selection of hotels offers exceptional comfort and service for you and your guests.
              </p>
              <p className="text-gray-700 mb-6 leading-relaxed">
                From opulent 5-star luxury hotels to charming boutique properties and practical budget accommodations, each property in our collection has been handpicked to ensure quality, convenience, and outstanding hospitality.
              </p>
              <div className="grid grid-cols-3 gap-6 text-center">
                ...
                <div>
                  ...
                  <h4 className="font-semibold text-purple-900">BEST RATES</h4>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-12 shadow-xl">
          <h2 className="text-3xl font-bold text-purple-900 mb-8 text-center uppercase tracking-wide">
            Complete Hotel Collections
          </h2>
          <p className="text-center text-gray-700 max-w-3xl mx-auto mb-8 leading-relaxed">
            Discover our extensive range of hotel accommodations perfect for weddings, events, and special occasions. From luxurious 5-star properties to cozy budget hotels and serviced apartments, we have the perfect accommodation to suit every need and budget.
          </p>
          <div className="text-center">
            <Link
              href="/venue-and-accommodation/all-venues?category=hotel-accommodation"
