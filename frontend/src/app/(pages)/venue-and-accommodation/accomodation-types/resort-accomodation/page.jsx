...
const ResortAccommodationPage = () => {
  ...
  const features = [
    { icon: Users, text: "10-500 Guests", color: "text-pink-300" },
    { icon: MapPin, text: "Scenic Locations", color: "text-purple-300" },
    { icon: Calendar, text: "Package Deals", color: "text-fuchsia-300" },
  ];
      ...
      <div className="relative h-[70vh] md:h-[77vh] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-4 py-6">
          ...
          <p className="text-sm md:text-base text-white/90 text-center max-w-xl mb-4 leading-relaxed">
            Experience the perfect blend of luxury, comfort, and natural beauty at our handpicked resort accommodations for your special celebrations.
          </p>
        ...
        <div className="py-2">
          <div className="animate-marquee whitespace-nowrap inline-block">
            <span className="text-purple-100 text-sm md:text-base font-light tracking-widest mx-8">
              ✨ LUXURY RESORTS FOR UNFORGETTABLE CELEBRATIONS
            </span>
            <span className="text-purple-100 text-sm md:text-base font-light tracking-widest mx-8">
              🌴 ESCAPE TO PARADISE & CELEBRATE IN STYLE
            </span>
            <span className="text-purple-100 text-sm md:text-base font-light tracking-widest mx-8">
              🏖️ WHERE DREAMS MEET NATURE
            </span>
            <span className="text-purple-100 text-sm md:text-base font-light tracking-widest mx-8">
              ✨ LUXURY RESORTS FOR UNFORGETTABLE CELEBRATIONS
            </span>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                We believe that your celebration deserves a breathtaking backdrop that combines natural beauty with world-class hospitality. Our curated collection of resort accommodations offers the perfect setting for destination weddings and special events.
              </p>
              <p className="text-gray-700 mb-6 leading-relaxed">
                From luxurious beachfront properties to serene forest retreats and charming cottage stays, each resort has been carefully selected to provide exceptional amenities, stunning surroundings, and unforgettable experiences for you and your guests.
              </p>
              <div className="grid grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-2">Luxury Comfort</p>
                </div>
                <div>
                  <div className="text-purple-600 mb-2">
                    <svg
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-12 shadow-xl">
          ...
          <p className="text-center text-gray-700 max-w-3xl mx-auto mb-8 leading-relaxed">
            Explore our extensive range of resort accommodations perfect for destination weddings, intimate ceremonies, and multi-day celebrations. From eco-friendly retreats to opulent luxury properties, discover the ideal setting that matches your vision and budget.
          </p>
...
export default ResortAccommodationPage;