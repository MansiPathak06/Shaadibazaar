...
import {
    ...
    Umbrella,
    Eye,
    CircleDollarSign, CircleDollar // ← Fixed: was CircleDollar
} from 'lucide-react';
import {
    Flower2,
    Castle,
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        <div className="text-white space-y-6 sm:space-y-8 animate-fade-in-up">
                            ...
                            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-3 sm:px-4 py-1.5 sm:py-2 border border-white/20">
                                ...
                                <span className="text-sm font-extralight">Award-Winning Venues</span>
                            </div>
        ...
        <section className="relative pt-16 sm:pt-20 lg:pt-30 bg-gradient-to-br from-slate-50 via-white to-blue-50 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    <p className="text-neutral-700 text-base sm:text-lg tracking-widest uppercase mb-2">Every event inspires us to create magic</p>
                </div>
    ...
    return (
        ...
        >
            ...
            <div className="relative h-full bg-white/70 backdrop-blur-xl border border-white/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:bg-white/80">
                ...
                <div className={`absolute inset-0 bg-gradient-to-r ${stat.color} rounded-2xl sm:rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 blur-sm`}></div>

                {/* Icon with floating animation */}
                <div className="relative mb-4 sm:mb-6">
                    <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-r ${stat.color} shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="text-center">
                    <div className="flex items-baseline justify-center mb-2">
                        ...
                        <span className={`text-2xl lg:text-3xl font-light bg-gradient-to-r ${stat.color} bg-clip-text text-transparent ml-1`}>
                            {stat.suffix}
                        </span>
                    </div>
                ...
                {/* Hover glow effect */}
                <div className={`absolute inset-0 bg-gradient-to-r ${stat.color} rounded-2xl sm:rounded-3xl opacity-0 group-hover:opacity-5 transition-opacity duration-500`}></div>
            </div>
        </div>
    );
}
        ...
        <section className="relative bg-gradient-to-br from-white via-gray-50 to-blue-50 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
                ...
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    <p className="text-neutral-700 text-base sm:text-lg tracking-widest uppercase mb-2">We design elegant venues blending nature and modern luxury</p>
                </div>
    ...
    return (
        ...
        >
            ...
            <div className="relative h-full bg-white/60 backdrop-blur-xl border border-white/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:bg-white/70 overflow-hidden">
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${highlight.bgGradient} opacity-0 group-hover:opacity-30 transition-all duration-500 rounded-2xl sm:rounded-3xl`}></div>

                {/* Animated border glow */}
                <div className={`absolute inset-0 bg-gradient-to-r ${highlight.gradient} rounded-2xl sm:rounded-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 -z-10 blur-sm`}></div>
                ...
                <div className="relative mb-4 sm:mb-6">
                    <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-r ${highlight.gradient} shadow-lg group-hover:scale-110 transition-all duration-300`}>
                        <IconComponent className="w-6 h-6 sm:w-8 sm:h-8 text-white" strokeWidth={2.5} />
                    </div>

                    {/* Icon glow effect */}
                    <div className={`absolute inset-0 w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-r ${highlight.gradient} opacity-0 group-hover:opacity-40 blur-lg transition-opacity duration-300`}></div>
                </div>
        ...
        <section id="venues" className="relative bg-gradient-to-br from-gray-50 via-white to-indigo-50 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
                ...
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    <p className="text-neutral-700 text-base sm:text-lg tracking-widest uppercase mb-2">Find the perfect outdoor venue for your special day</p>
                </div>
        ...
        <section className="relative bg-gradient-to-br from-gray-50 via-white to-purple-50 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-neutral-700 text-lg tracking-widest uppercase mb-2"> From planning to execution, we provide everything you need for your perfect outdoor celebration</p>
                </div>
    ...
    return (
        ...
        >
            <div className="relative h-full bg-white/70 backdrop-blur-xl border border-white/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105">
                ...
                {/* Gradient background overlay */}
                <div className={`absolute inset-0 bg-gradient-to-br ${service.bgGradient} opacity-0 group-hover:opacity-30 transition-all duration-500 rounded-2xl sm:rounded-3xl`}></div>

                {/* Icon */}
                <div className="relative mb-4 sm:mb-6">
                    <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-r ${service.gradient} shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                        <IconComponent className="w-6 h-6 sm:w-8 sm:h-8 text-white" strokeWidth={2.5} />
                    </div>
                </div>
                    ...
                    <div className="space-y-3">
                        {service.features.map((feature, idx) => (
                            <div key={idx} className="flex items-center gap-3">
                                <div className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-gradient-to-r ${service.gradient} flex items-center justify-center flex-shrink-0`}>
                ...
                {/* Hover glow effect */}
                <div className={`absolute inset-0 bg-gradient-to-r ${service.gradient} rounded-2xl sm:rounded-3xl opacity-0 group-hover:opacity-5 transition-opacity duration-500`}></div>
            </div>
        </div>
    );
}
        ...
        <section className="relative bg-gradient-to-br from-white via-gray-50 to-indigo-50 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-neutral-700 text-lg tracking-widest uppercase mb-2">Explore real celebrations and get inspired by the beauty of outdoor events</p>
                </div>
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-12 sm:mb-16 gap-6">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                        ...
                        >
                            <Play className={`w-3 h-3 sm:w-4 sm:h-4 ${isAutoPlaying ? 'animate-pulse text-green-500' : ''}`} />
                            ...
                            <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6">
                                <div className="bg-white/90 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                                    <div className="flex items-center justify-between gap-3">
                                        <div>
                                            <div className={`inline-flex items-center gap-2 bg-gradient-to-r ${getCategoryColor(GALLERY[index].category)} rounded-full px-2 sm:px-3 py-0.5 sm:py-1 mb-1 sm:mb-2`}>
                                                <span className="text-white text-xs sm:text-sm font-medium">{GALLERY[index].category}</span>
                                            </div>
                                            <p className="text-gray-900 font-semibold text-sm sm:text-base">{GALLERY[index].alt}</p>
                                        </div>
                                ...
                                <div key={idx} className="group cursor-pointer" onClick={() => setIndex(idx)}>
                                    <div className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-white/70 backdrop-blur-xl border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                                        ...
                                        <div className="absolute bottom-3 left-3 sm:bottom-4 sm:left-4">
                                            <div className={`inline-flex items-center gap-1 bg-gradient-to-r ${getCategoryColor(GALLERY[idx].category)} rounded-full px-2 py-0.5 sm:px-2 sm:py-1 mb-1`}>
                                                <span className="text-white text-xs font-medium">{GALLERY[idx].category}</span>
                                            </div>
                                            <p className="text-white text-xs sm:text-sm font-medium">{GALLERY[idx].alt}</p>
                                        </div>
                                    </div>
                                </div>
                            );
                ...
                <div className="flex justify-center gap-1.5 sm:gap-2 mb-8 sm:mb-12">
                    {GALLERY.map((_, i) => (
                        <button
                            key={i}
                            onClick={() => setIndex(i)}
                            className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-all duration-300 ${i === index
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                    {[
                        { icon: Sparkles, text: "Walk down floral aisles", gradient: "from-pink-500 to-rose-500" },
                        { icon: Sparkles, text: "Exchange vows under golden sunsets", gradient: "from-amber-500 to-orange-500" },
                        { icon: Sparkles, text: "Dine beneath a canopy of stars", gradient: "from-purple-500 to-violet-500" },
                        { icon: Sparkles, text: "Create magical memories", gradient: "from-blue-500 to-indigo-500" }
                    ].map((item, i) => (
                        <div key={i} className="text-center group">
                            <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-r ${item.gradient} shadow-lg mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300`}>
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
                ...
                <div className="text-center mb-16 sm:mb-20">
                    <div className="inline-flex items-center gap-2 bg-white/40 backdrop-blur-md rounded-full px-4 sm:px-6 py-2 sm:py-3 border border-white/30 mb-6 sm:mb-8 shadow-lg">
                        ...
                        <span className="text-xs sm:text-sm font-semibold text-gray-700 tracking-wide">Happy Couples</span>
                    </div>
                ...
                <div className="mb-12 sm:mb-16">
                    <div className="relative max-w-4xl mx-auto">
                        <div className="bg-white/70 backdrop-blur-xl border border-white/30 rounded-2xl sm:rounded-3xl p-8 sm:p-12 shadow-2xl">
                            <div className={`absolute -top-4 sm:-top-6 left-8 sm:left-12 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r ${TESTIMONIALS[currentTestimonial].gradient} rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg`}>
                            ...
                            <div className="text-center">
                                ...
                                <div className="flex items-center justify-center gap-3 sm:gap-4">
                                    ...
                                    <div className="text-left">
                                        <p className="text-lg sm:text-xl font-bold text-gray-900">{TESTIMONIALS[currentTestimonial].name}</p>
                                        <p className="text-sm sm:text-base text-gray-600">{TESTIMONIALS[currentTestimonial].event}</p>
                ...
                <div className="flex justify-center gap-2 sm:gap-3 mb-16 sm:mb-20">
                    {TESTIMONIALS.map((_, i) => (
                        <button
                            ...
                            className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full transition-all duration-300 ${i === currentTestimonial
    ...
    return (
        ...
        >
            <div className="relative bg-white/70 backdrop-blur-xl border border-white/30 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105">
                <div className={`absolute -top-3 sm:-top-4 right-6 sm:right-8 w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-r ${testimonial.gradient} rounded-full flex items-center justify-center shadow-lg`}>
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-gray-600">{testimonial.event}</p>
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
                ...
                <div className="text-center mb-16 sm:mb-20">
                    <div className="inline-flex items-center gap-2 bg-white/40 backdrop-blur-md rounded-full px-4 sm:px-6 py-2 sm:py-3 border border-white/30 mb-6 sm:mb-8 shadow-lg">
                        ...
                        <span className="text-xs sm:text-sm font-semibold text-gray-700 tracking-wide">Start Your Journey</span>
                    </div>
                        ...
                        <div className="bg-white/70 backdrop-blur-xl border border-white/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-2xl">
                            ...
                            {isSubmitted ? (
                                <div className="text-center py-8 sm:py-12">
                                    ...
                                    <h4 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Thank You!</h4>
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                {[
                                    ...
                                    <div key={i} className="flex items-start gap-3 sm:gap-4 group">
                                        <div className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r ${step.gradient} rounded-xl sm:rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
                        ...
                        <div className="bg-white/70 backdrop-blur-xl border border-white/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg">
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                {[
                                    ...
                                    <div key={i} className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white/50 rounded-xl sm:rounded-2xl backdrop-blur-sm group hover:bg-white/70 transition-all duration-300">
                                        <div className={`w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r ${contact.gradient} rounded-lg sm:rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                                            <contact.icon className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                                        </div>
                                        <span className="text-gray-800 font-medium text-xs sm:text-sm">{contact.text}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
